...
export default {
  ...
  props: {
    icon: {
      required: true,
      type: String,
      validator: /^home|bank|creditcard|chart|settings|account|logout$/
      },
    },
    path: {
      default: "/",
